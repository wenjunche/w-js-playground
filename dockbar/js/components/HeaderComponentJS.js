var HeaderComponent = React.createClass({
    close: function () {
        if (this.props.exit === true) fin.desktop.Application.getCurrent().close();else fin.desktop.Window.getCurrent().close();
    },

    exit: function () {
        if (this.props.onClosing) this.props.onClosing(this.close);else this.close();
    },
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement("img", { style: imageStyle, src: "img/infusion-logo.png", alt: "Powered by Infusion", title: "Powered by Infusion" }),
            React.createElement("img", { style: exitImageStyle, onClick: this.exit, id: "closeButton", className: "non-draggable close", src: exitImageSrc, alt: "close" }),
            React.createElement("img", { onClick: this.publishUndock, style: undockImageStyle, id: "undockButton", ref: "undockButton", className: "non-draggable close", height: "15", width: "15", src: "img/undock.png", alt: "Undock" }),
            React.createElement(
                "span",
                { className: "caption" },
                this.props.caption
