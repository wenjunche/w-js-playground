var DockbarMenu = React.createClass({
    ...
    initWindows: function () {
        this.windows = {
            activityDockbarButton: [{ dockingParent: "activity", dockingPosition: "right", height: "218", width: "550", top: "480", left: "970", windowName: "new-instruments-activity", url: "activity-newInstruments.html" }, { dockingParent: "new-instruments-activity", dockingPosition: "bottom", height: "311", width: "550", top: "150", left: "970", windowName: "attributes-activity", url: "activity-attributesActivity.html" }, { dockingParent: "new-instruments-activity", dockingPosition: "right", height: "402", width: "235", top: "150", left: "720", windowName: "hourly-daily-activity", url: "activity-hourlyDailyTotalsComponent.html" }, { dockingParent: "", dockingPosition: "", height: "530", width: "675", top: "150", left: "30", windowName: "activity", url: "activity-main.html" }],

            slaDockbarButton: [{ dockingParent: "sla", dockingPosition: "right", height: "247", width: "955", top: "150", left: "720", windowName: "sla-quality", url: "sla-quality.html" }, { dockingParent: "sla-quality", dockingPosition: "bottom", height: "238", width: "955", top: "420", left: "720", windowName: "sla-outbound-files", url: "sla-outbound-files.html" }, { dockingParent: "sla-outbound-files", dockingPosition: "bottom", height: "278", width: "675", top: "680", left: "720", windowName: "sla-total", url: "sla-total.html" }, { dockingParent: "", dockingPosition: "", height: "574", width: "650", top: "150", left: "50", windowName: "sla", url: "sla-main.html" }] };
    },
    ...
    onAllWindowClosed: function (componentId) {
        ...
        var anyWindowsOpen = _.find(values, function (a) {
            return a;
        });
        if (!anyWindowsOpen) {
            $("#dockAllSpan").hide();
    ...
    dockAllWindows: function () {
        ...
        keys.forEach(function (key) {
            ...
            if (value === true) this.refs[key].showWindows(this.addWindowsinGroup);
        }, this);
    },
    ...
    joinWindows: function (remainingWindows, window, childWindows) {
        ...
        var targetWindow = _.find(childWindows, function (child) {
            return child.name === window.dockingParent;
        });
        ...
        var windowToDock = _.find(childWindows, function (child) {
            return child.name == window.windowName;
        });
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "span",
                { "data-tooltip": "Activity", id: "activitySpan" },
                React.createElement(DockbarButton, { ref: this.activityDockBarKey, componentId: this.activityDockBarKey, Text: "Activity", windows: this.windows[this.activityDockBarKey], src: "img/activity_inactive.png", onWindowCreated: this.onWindowCreated, onWindowClosed: this.onWindowClosed, onAllWindowClosed: this.onAllWindowClosed })
            ),
            React.createElement(
                "span",
                { "data-tooltip": "SLA", id: "slaSpan" },
                React.createElement(DockbarButton, { ref: this.slaDockBarKey, componentId: this.slaDockBarKey, Text: "SLA", windows: this.windows[this.slaDockBarKey], src: "img/sla_inactive.png", onWindowCreated: this.onWindowCreated, onWindowClosed: this.onWindowClosed, onAllWindowClosed: this.onAllWindowClosed })
            ),
            React.createElement(
                "span",
                { "data-tooltip": "Dock All", id: "dockAllSpan" },
                React.createElement("img", { id: "dockAllButton", src: "img\\dockall.png", style: imageStyle, onClick: this.dockAllWindows })
            ),
            React.createElement(
                "span",
                { "data-tooltip": "Undock All", id: "undockAllSpan" },
                React.createElement("img", { id: "undockall", src: "img\\undockall.png", style: imageStyle, onClick: this.undockAllWindows })
            ),
            React.createElement(
                "span",
                { "data-tooltip": "Start", id: "startSpan" },
                React.createElement("img", { id: "startButton", src: "img\\play.png", style: imageStyle, onClick: this.startPlaying })
            ),
            React.createElement(
                "span",
                { "data-tooltip": "Pause", id: "pauseSpan" },
                React.createElement("img", { id: "pauseButton", src: "img\\pause.png", style: imageStyle, onClick: this.stopPlaying })
            ),
            React.createElement("span", { id: "dateSpan" })
        );
    }
});
