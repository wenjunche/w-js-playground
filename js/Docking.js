...
window.addEventListener("DOMContentLoaded", function() {
  if (window.fin) {
    fin.desktop.main(function () {
        ...
        fin.desktop.InterApplicationBus.subscribe("*", "FlexTopic", function(data, uuid, name) {
            try {
        ...
        function createChildWindow1() {
            var dw = new fin.desktop.Window({"name":"c9376a5c-d415-4466-9514-78e8f8816dab","autoShow":true,"url":"https://collab.reutest.com/eikonmessenger","showTaskbarIcon":false},
                function(d) {
                    console.log(d);                    
                },
                function(e) {
...
//            });
            ...
            var dw = new fin.desktop.Window({
                ...
                taskbarIconxx: 'file://C:/Users/richard/Downloads/tullet-docking-demo/static/Redi.ico',
                taskbarIconGroupxx: 'bigw2',
                defaultWidth: 500,
                defaultHeight: 500,
                minWidth2: 200,
                maxWidth2: 800,
                minHeight2: 200,
                maxHeight2: 300,
                defaultTop: 110, //100 + (cc * 10),
                defaultLeft: 110, //100 + (cc * 10),
                frame: false,
                resize: true,
                autoShow: false,
...
//                dw.updateOptions({"alwaysOnTop":true,"contextMenu":true,"cornerRounding":{"height":130,"width":130},"frame":false});
                    ...
                    //dw.setBounds(0,0,1721,953);
                    dw.show();
//                    setTimeout( () => dw.hide(), 1000);
//                    dw.focus();
            }, function(v) {
...
//                    dw.removeEventListener("closed", closedListener1);
            ...
            dw.addEventListener("closed", function closedListener2(v){ 
                console.log("closed 2", v);
                setTimeout(function() {
//                    dw.removeEventListener("closed", closedListener2);
                }, 0); 
            });
...
//            });            
        ...
        function createApp() {
            var app  = new fin.desktop.Application({name:'FX Derivatives', 
                                        ...
                                        applicationIcon: "http://localhost:8081/gkxx.ico",
                        ...
                        function(d) {
                            ...
                            app.run(function(d){
                                ...
                                app.setTrayIcon("https://developer.openf.in/download/openfin111.png", function() {
                                console.log("tray icon clicked");
                            }, function() {console.log('tray icon loaded')}, 
                                function(e) {console.log(e); console.log('setTrayIcon again');

                                app.setTrayIcon("https://developer.openf.in/download/openfin.png", function() {
                                        console.log("tray icon clicked");
                                    });
                                });
        ...
        function createOWA() {
            var app  = new fin.desktop.Application({name:'OWA', 
                                        uuid:'OWA', 
        ...
        fin.desktop.InterApplicationBus.publish("scout-sector-selected", tempSector);
    ...
    document.getElementById("printMe").addEventListener("dragstart", function(event){
        ...
        event.dataTransfer.setData("application/json", "{'data': 'standard json'}");
    });
    ...
    document.getElementById("customContextMenu").addEventListener("contextmenu", showCustomContextMenu);



    function speak() {
        var speech = new SpeechSynthesisUtterance('Build Once. Deploy Instantly. Run Natively')
